...
export default function Pricing() {
  ...
  return (
    <div>
      ...
      >
        Subscribe for the best <span className="text-yellow-500">deals</span>{" "}
        and never miss on the latest market trends
      </p>
      <div className="flex mx-auto w-2/3 justify-around mt-10 flex-wrap ">
        ...
        >
          ...
          <p className="text-gray-600 ml-2 mt-2">
            Great for starting with crypto and NFT's.
          </p>
          <p className="text-gray-600 text-center mt-2">∘₊✧──────✧₊∘</p>
          <p className="text-gray-600 text-center mt-2">Features</p>

          <p className="text-gray-600 ml-2 mt-2">✅Access to limited data</p>
          <p className="text-gray-600 ml-2 mt-2">✅No hot deals</p>
          <p className="text-gray-600 ml-2 mt-2">
            ✅API access for limited data
          </p>
        ...
        >
          ...
          <p className="text-gray-600 ml-2 mt-2">✅Hot deals</p>
          <p className="text-gray-600 ml-2 mt-2">✅API access for all data</p>
        ...
        >
          ...
          <p className="text-gray-600 ml-2 mt-2">
            Good for pro users , provides indepth data.
          </p>
          <p className="text-gray-600 text-center mt-2">∘₊✧──────✧₊∘</p>

          <p className="text-gray-600 text-center mt-2">Features</p>
          <p className="text-gray-600 ml-2 mt-2">✅Access to all data</p>
          <p className="text-gray-600 ml-2 mt-2">✅Hot deals and offers</p>
          <p className="text-gray-600 ml-2 mt-2">✅API access for all data</p>
